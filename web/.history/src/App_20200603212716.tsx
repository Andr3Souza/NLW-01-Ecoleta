...
function App() {
  ...
  //Seguindo o conceito de imutabilidade do JS esta função utiliza um setCounter para setar um novo valor para o counter, e nnão alterar o existente de forma direta
